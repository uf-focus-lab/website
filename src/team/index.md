...
<People name="Hannah Kirkland" image="hannah-kirkland" :links="{email: 'mailto:hkirkland@ufl.edu'}">
...
<People name="Michael Tomadakis" image="michael-tomadakis" :links="{email: 'mailto:m.tomadakis@ufl.edu'}">
...
<People name="Jacob Carter" image="jacob-carter" :links="{email: 'mailto:carterjacob@ufl.edu'}">
...
<People name="Dillon Gutowski" image="dillon-gutowski" :links="{email: 'mailto:dillongutowski@ufl.edu'}">
