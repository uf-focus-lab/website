...
Data is available upon request from the authors. The only fee would be to cover the cost of a hard disk and shipping for the full light transport dataset. Single frames of light transport are available upon request for free via electronic download. Please contact Xiaomeng Liu by [liuxiaomeng51@ufl.edu](mailto:liuxiaomeng51@ufl.edu).
