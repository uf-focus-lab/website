...
<div style="display: flex; flex-direction: row; justify-content: space-between;">
  <img src="./front-view.jpg" style="width: calc(53% - 0.5ch); height: auto;" alt="Front View" />
  <img src="./calib-adjust.png" style="width: calc(47% - 0.5ch); height: auto;" alt="Top View" />
</div>
