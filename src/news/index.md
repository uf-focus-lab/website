...
<Item date="02/01">Paper accepted to ICASSP on event camera EPIs. Congrats to our ASU collaborators!</Item>
<Item date="01/02">Dr. Koppal will be an area chair for ECCV 2026. Happy New Year! </Item>
</Year>

## 2025

| 11/15 | Congrats to Michael Tomadakis and his FOCUS lab co-authors on the accepted WACV 2026 paper "Augmenting with NeRFs: Fast Relocalization on Densified Datasets". |
| :-- | :-- |
| 10/14 | FOCUS lab received an Amazon grant on removing rolling shutter effects. Congrats to our collaborators in UF ECE, Dr. Woodard and Dr. Islam! |
| 09/29 | Dr. Koppal will be a Lead Area Chair for CVPR 2026. |
| 09/01 | FOCUS Lab will support a research experience for undergraduates program for eight students in 2025-26. Application due Sept 15th 2025. Please email Dr. Koppal for more information. |
| 08/08 | Dr. Koppal will be an area chair for CVPR 2026 |
| 07/21 | ICCP 2025 in Toronto! Dr. Koppal is a PAMI area chair for ICCP 2025. |
| 05/23 | Our IoT4Ag based collaboration with UPenn for robotic monitoring of colorimetric sensors was presented at ICRA workshop for [precision agriculture](https://ag-tech-icra2025.com/). |
| 05/19 | Dr. Koppal gave a talk at Vanderbilt University's Computer Science department on Foveated Imaging for Robotics. |
| 03/11 | Our work on Physics-Informed Neural Networks for SAM Image Enhancement for semiconductor inspection was accepted to ECTC. Congrats to our collaborators in Dr. Asadi's lab. |
| 01/25 | New Ph.D. student Thiago Cuevas joins the FOCUS lab. Welcome! |
...
| 11/28 | FOCUS lab moves to the new [Malachowsky Hall](https://research.ufl.edu/malachowsky-hall.html)! |
| :-- | :-- |
...
| 05/18 | See more about our CVPR 2023 paper “Energy-Efficient Adaptive 3D Sensing” at [Snap Research](https://research.snap.com/publications/publication.html#energy-efficient-adaptive-3d-sensing). |
| 04/30 | FOCUS lab was awarded an ONR grant to work on optical computing. |
| 04/06 | Hannah Kirkland's extended abstract “Schrödinger’s Camera: First Steps Towards a Quantum-Based Privacy Preserving Camera” has been accepted to [Women in Computer Vision (WiCV @ CVPR 2023)](https://sites.google.com/view/wicv/). Congrats Hannah! |
| 04/03 | Hannah Kirkland's paper “Schrödinger’s Camera: First Steps Towards a Quantum-Based Privacy Preserving Camera” has been accepted to [The Fourth Workshop on Fair, Data-Efficient, and Trusted Computer Vision (TCV)](https://fadetrcv.github.io/2023/). Congrats Hannah! |
| 03/15 | Our paper “Schrödinger’s Camera: First Steps Towards a Quantum-Based Privacy Preserving Camera” has been submitted to [arXiv.](https://arxiv.org/abs/2303.07510) |
| 03/01 | Congratulations to Brevin Tilmon for his accepted CVPR paper titled [“Energy-Efficient Adaptive 3D Sensing”](https://btilmon.github.io/e3d.html) and congratulations to our collaborators at Snap Research! |
| 02/16 | FOCUS lab worked with Dr. Eakta Jain in CISE on [personal space bubbles](https://focus.ece.ufl.edu/wp-content/uploads/2023/06/Personal_Safety_Bubble_VR2023_poster.pdf) which is a poster in IEEE VR 2023. Congrats to our collaborators! |
| 01/18 | Hannah Kirkland has been selected to attend the [Grad-Cohort for Women Workshop.](https://cra.org/cra-wp/grad-cohort-for-women/?utm_source=CRA-WP+Updates&utm_campaign=5e63f0d699-EMAIL_CAMPAIGN_2019_09_27_01_21_COPY_01&utm_medium=email&utm_term=0_24729738cd-5e63f0d699-82426629) Congrats Hannah! |
| 01/17 | Dr. Xiameng’s Liu’s paper [“Event-based Dual Photography for Transparent Scene Reconstruction”](https://focus.ece.ufl.edu/event-based-dual-photography-for-transparent-scene-reconstruction/) is accepted to Optics Letters. Congratulations to Dr. Liu and our collaborators at ASU! |
| 01/05 | Yuxuan Zhang joins FOCUS lab as a Ph.D. student. Welcome Yuxuan! |

## 2022

| 11/07 | Dr. Koppal becomes an [Amazon Scholar with Amazon Robotics.](https://www.amazon.science/scholars/) |
| :-- | :-- |
| 08/10 | FOCUS lab releases the [Plausible Planetary Material Geometry and Reflectance Imaging Dataset (PPMGR)](https://focus.ece.ufl.edu/ppmgr-dataset/) in collaboration with NASA’s Ames Research Center. |
...
| 03/01 | Our paper [“Optical MEMS enable next generation solutions for robot vision and human-robot interaction”](https://www.spiedigitallibrary.org/conference-proceedings-of-spie/12013/2613458/Optical-MEMS-enable-next-generation-solutions-for-robot-vision-and/10.1117/12.2613458.short?SSO=1) was published in SPIE OPTO. |
| 03/01 | Our ICCV 2021 paper “SaccadeCam: Adaptive Visual Attention for Monocular Depth Sensing” was featured in the latest [NELMS Institute Newsletter](https://iot.institute.ufl.edu/2022/03/research-spotlight-saccadecam-adaptive-visual-attention-for-monocular-depth-sensing/). |
...
| 10/07 | FOCUS Lab has just joined an NSF ERC initiative for agrotech. We look forward to building adaptive spectral zoom cameras for [IoT4Ag](https://nsf.gov/awardsearch/showAward?AWD_ID=1941529). |
| 09/13 | FOCUS lab’s privacy work highlighted in [UF Explore](https://explore.research.ufl.edu/trusting-tech.html). |
...
| 03/29 | Our paper “SaccadeCam: Adaptive Visual Attention for Monocular Depth Sensing” has been submitted to [arXiv](https://arxiv.org/abs/2103.12981). |
| 03/22 | FOCUS Lab helps to grow coffee in Florida? Catch the news [here](https://www.growingproduce.com/farm-management/fresh-coffee-from-florida-scientists-are-brewing-up-the-possibility/) and [here](https://vscnews.com/florida-coffee-ai/). |
...
| 03/24 | Our paper “A MEMS-Based Foveating Lidar to Enable Real-Time Adaptive Depth Sensing” has been submitted to [arxiv](https://arxiv.org/pdf/2003.09545.pdf). |
...
| 02/03 | Our CVPR 2019 paper featured in [Computer Vision News](https://www.rsipvision.com/ComputerVisionNews-2020February/4/)! |
| 01/23 | New paper accepted to TVCG track at IEEE VR 2020. Congrats to our collaborators in [Dr. Jain’s lab](https://jainlab.cise.ufl.edu/index.html)! |
...
| 06/19 | Congrats to Francesco Pittaluga on being awarded a [2018 Microsoft Research Dissertation Grant](https://www.microsoft.com/en-us/research/academic-program/dissertation-grant/)! |
...
| 05/04 | See you in Pittsburgh for [ICCP 2018](http://iccp2018.ece.cmu.edu/). Dr. Koppal is co-chair of posters and demos. |
...
| 02/15 | Dr. Koppal gave an invited talk at Arizona State University’s [SENSIP](https://sensip.engineering.asu.edu/). |
| 02/14 | Dr. Koppal gave an invited talk at Phenome 2018 in Tucson, AZ |
| 01/11 | FOCUS lab received a [MIST award](http://www.mist-center.org/) for micro-LIDAR. Congratulations to the micro-LIDAR team! |
